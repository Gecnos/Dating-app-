                ...
                <form onSubmit={handleSubmit} className="space-y-10 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pb-10">
                        <button
                            ...
                            className={`w-full py-5 rounded-[2rem] font-black text-xs uppercase tracking-[0.3em] shadow-2xl transition-all active:scale-95 transition-colors duration-500 ${!data.name || !data.date_of_birth || !data.gender
