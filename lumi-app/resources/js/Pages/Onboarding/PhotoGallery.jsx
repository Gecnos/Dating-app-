            ...
            <div className="flex-1 flex flex-col space-y-8 z-10">
                ...
                <div className="pb-10">
                    <button
                        ...
                        className={`w-full py-5 rounded-[2rem] font-black text-xs uppercase tracking-[0.3em] shadow-2xl transition-all active:scale-95 transition-colors duration-500 ${processing || data.photos.filter(img => img !== null).length === 0
